  ...
  return (
    <div className="h-full w-full bg-white">
      ...
      <div className="z-10 grid h-screen grid-cols-7 place-items-center">
        <section className="col-span-5 mr-20 flex w-3/6 flex-col p-6">
        ...
        <section className="col-span-2 flex w-9/12 flex-col justify-center rounded-2xl bg-white/10 p-6 shadow-lg backdrop-blur-sm">
