...
export default function BackupsPage() {
  return (
    <>
      <PageTitle title="Base de datos" subtitle="Aquí puede realizar respaldo y recuperación de la base de datos." />
      <section className="flex flex-col lg:flex-row justify-center p-4 w-fit mx-auto gap-4">
        <div className="bg-white rounded-lg p-4 mx-auto shadow">
          <h3 className="font-bold tracking-tighter text-2xl text-center mb-0">Respaldo de base de datos</h3>
