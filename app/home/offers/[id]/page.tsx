...
export default async function OfferPage({ params: { id } }: Context) {
  ...
  return (
    <section className="flex flex-col gap-4 px-2 pt-2 lg:flex-row lg:px-4 lg:pt-4">
      <div className="card bg-white shadow-md lg:w-3/4">
        <div className="p-6 lg:card-body lg:flex lg:flex-row">
          <div className="lg:w-4/5">
            ...
            <p className="mt-2 text-3xl">
              <span className="font-bold text-green-600">{offer?.salary} $/hr</span>
            </p>
            <div className="mt-4 flex w-full gap-x-4 lg:w-auto">
      ...
      <div className="card bg-white p-8 shadow-md lg:w-1/4 lg:self-start">
        ...
        <div className="mt-4 flex items-center gap-2">
          <AvatarIcon username={offer.company.name} />
          <h3 className="card-title text-xl font-semibold">{offer.company.name}</h3>
        </div>
        <p className="mt-2 line-clamp-3">{offer.company.description}</p>
