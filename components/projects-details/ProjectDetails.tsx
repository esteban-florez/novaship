        ...
        <div className="col-span-6 flex flex-col rounded-lg rounded-t-none bg-white py-4 md:col-span-4 md:rounded-l-none md:rounded-t-lg">
          <div className="flex justify-between">
            <div className="container pl-5">
              <h3 className="text-base font-bold sm:text-2xl">Mi proyecto</h3>
              <p className="sm: line-clamp-6 text-sm">Responsable: Myriam Yaqueno</p>
              <p className="sm: line-clamp-6 text-sm">Fecha: 20/06/2023</p>
            </div>
