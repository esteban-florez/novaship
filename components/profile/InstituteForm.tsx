  ...
  return (
    <div className="mb-8 mt-4 flex flex-col gap-x-2 border-t border-neutral-content pt-4 last:mb-4 lg:flex-row lg:px-4">
      ...
      <div className="mt-4 lg:form-control lg:mt-0 lg:w-2/4">
        <InputSimple id="companyName" type="text" label="Nombre" placeholder="UPTA Federico Brito Figueroa" classes="w-full input input-md input-primary mb-3" />
        <InputSimple id="companyEmail" type="email" label="Correo electrónico" placeholder="correoinstitucional@gmail.com" classes="w-full input input-md input-primary" />
      </div>
    </div>
  )
}
  ...
  return (
    <div className="mb-8 mt-4 flex flex-col gap-x-2 border-t border-neutral-content pt-4 last:mb-4 lg:flex-row lg:px-4">
      ...
      <div className="mt-4 lg:form-control lg:mt-0 lg:w-2/4">
        ...
        <textarea id="bio" className="textarea w-full resize-none border-primary" placeholder="Buscamos formar a futuros profesionales..." rows={10} />
      </div>
    </div>
  )
}
  ...
  return (
    <div className="mb-8 mt-4 flex flex-col gap-x-2 border-t border-neutral-content pt-4 last:mb-4 lg:flex-row lg:px-4">
      ...
      <div className="mt-4 lg:form-control lg:mt-0 lg:w-2/4">
        ...
        <InputSimple id="address" type="text" label="Dirección" placeholder="Calle Bolívar cruce con Paez" classes="w-full input input-md input-primary mb-3" />
      </div>
    </div>
  )
}
...
export default function InstituteForm() {
  return (
    <form className="w-full rounded-lg bg-neutral p-8 lg:px-16">
      <h2 className="mb-4 border-b text-2xl font-bold">Institución</h2>
      <ImageInput />
      <NameSection />
      <DescriptionSection />
      <ContactSection />
