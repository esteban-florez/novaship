...
export default function General({ setStep }: Props) {
  return (
    <>
      <div className="grid h-screen grid-cols-7 place-items-center">
        <div className="z-20 col-span-2 flex w-9/12 flex-col justify-center rounded-2xl bg-white/10 p-6 shadow-lg backdrop-blur-sm">
