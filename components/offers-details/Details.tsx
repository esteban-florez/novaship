...
export default function Details({ isOwner, title, description, expiresAt, fields, updateOffer }: Props) {
  return (
    <div className="card rounded-xl bg-white shadow-xl lg:flex-row">
      <div className="relative flex lg:basis-2/5">
        ...
        <img
          ...
          className="h-32 w-full select-none rounded-t-lg object-cover md:h-44 lg:rounded-l-lg"
        />
