...
export default function Content(props: Props) {
  return (
    <section className="w-full h-72 md:w-[36.5rem] flex">
      <div className="bg-gray-900/70 flex flex-col justify-center p-7 pb-16">
        ...
        <p className="line-clamp-3 py-2 text-white sm:pt-7 xl:py-3">{props.description}</p>
        <div className="flex flex-col justify-between gap-4 sm:flex-row md:items-center lg:gap-6">
          {props.destination === 'offers' &&
